        ...
        <div class="mt-4 pr-1">
            ...
            <div>
                ...
                <b-row class="text-right text-dark h6">
                    <b-col class="mt-3" lg="6" md="6" cols="12" sm="12"> <label for="name">نام</label>
                        <BaseInput type="text" iconSrc="/icons/person.svg" v-model="name" />
                    </b-col>
                    <b-col class="mt-3" lg="6" md="6" cols="12" sm="12"> <label for="lastname"> نام خانوادگی</label>
                        <BaseInput type="text" iconSrc="/icons/person.svg" v-model="lastname" />
                    </b-col>
                    <b-col class="mt-3" lg="6" md="6" cols="12" sm="12"> <label for="email">ایمیل</label>
                        <BaseInput type="email" iconSrc="/icons/email.svg" v-model="email" />
                    </b-col>
                    <b-col class="mt-3" lg="6" md="6" cols="12" sm="12"> <label for="phone">شماره موبایل</label>
                        <BaseInput type="tel" iconSrc="/icons/telephone.svg" v-model="mobile" />

                    </b-col>
                    <b-col class="mt-3" lg="6" md="6" cols="12" sm="12"> <label for="password"> رمز عبور</label>
                        <BaseInput type="password" iconSrc="/icons/password.svg" v-model="password" />
                    </b-col>
                    <b-col class="mt-3" lg="6" md="6" cols="12" sm="12"> <label for="confirmPassword"> تکرار رمز
                            عبور</label>
