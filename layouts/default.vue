...
export default {
  ...
  computed: {
    ...
    shouldShowSidebar() {
      ...
      const pagesWithSidebar = ['dashboard','dashboard-stations','dashboard-learning-id','dashboard-learning','dashboard-order','dashboard-order-create','dashboard-priceMaterial','dashboard-comment','dashboard-profile']; // Replace with actual page names
